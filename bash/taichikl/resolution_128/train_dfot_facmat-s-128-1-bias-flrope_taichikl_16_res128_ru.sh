python main.py \
    '+name=test_DFOT_FacMat-S-128-1-Bias-FLRope_TAICHIKL_16_Res128_RU' \
    ...
    '@FacMatDiT/group_S/S-128-1' \
    algorithm.backbone.use_bias=True \
    algorithm.backbone.flatten_matrix_rope=True \
    ...
    experiment.validation.limit_batch=20 \
    \
